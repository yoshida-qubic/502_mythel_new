			...
			<div class="box">
					...
					<div class="swiper-container">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<img src="<?php echo $imgDir; ?>slider01.png">
							</div>
							<div class="swiper-slide">
								<img src="<?php echo $imgDir; ?>slider02.png">
							</div>
							<div class="swiper-slide">
								<img src="<?php echo $imgDir; ?>slider03.png">
							</div>

							<div class="swiper-slide">
								<img src="<?php echo $imgDir; ?>slider04.png">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="bottom">
					...
					<div class="cta_zone">
						...
						<!-- <div class="link purple"><a href="<?php echo $reserved; ?>" target="_blank">札幌大通り店の予約はこちら ▶︎</a></div> -->
