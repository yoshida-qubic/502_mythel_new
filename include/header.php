...
<head>
  ...
  <title><?php echo $meta_ttl; ?>定額制セルフエステ MYTHEL SelfBeautyGym</title>
  ...
  <!--[if lt IE 9]>
	<script type="text/javascript" src="<?php echo $dir; ?>js/selectivizr-min.js" defer></script>
	<script type="text/javascript" src="<?php echo $dir; ?>js/html5shiv.min.js" defer></script>
	<![endif]-->
</head>
...
<body class="preload">
  <div id="wrapper">
    <header>
      ...
      <div class="header_in">
        <h1 class="logo"><a href="<?php echo $dir; ?>"><img src="<?php echo $dir; ?>images/common/logo01.png" alt="MYTHEL"></a></h1>
        <nav>
          ...
          <ul class="kapital_t">
            ...
            <li class="h_reserved"><a href="<?php echo $dir; ?>salonlist/">RESERVED</a></li>
          </ul>

          <ul class="consent is_sp">
